...
const myFirstArray = [1, 'apple', true, 2, 'pear'];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = [1, 2, 'pear', 'pineapple', 'watermelon', 6];
...
const myInformation = ['Ann', 24, 'september', 'Libra'];
...
const squaredNumbers = numbers.map ((elem) => {
    return elem ** 2;
});
...
let addCities = ['Санкт-Петербург', 'Москва', 'Екатеринбург'];
let cities = [...addCities, ...russianCities];
console.log(cities);
